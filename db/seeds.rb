...
User.create(username: 'Kurt Cobain', email: 'admin@example.org', password: 'admin!', password_confirmation: 'admin!', how_found_tweechable: "Friend!", admin:true)
u1 = User.create(username: 'Grace Hopper', email: 'grace@example.org', password: 'cobol!', password_confirmation: 'cobol!', how_found_tweechable: "Friend!", admin:false)
u2 = User.create(username: 'Cookie Monster', email: 'cookie@example.org', password: 'cookies', password_confirmation: 'cookies', how_found_tweechable: "Twitter!", admin:false)
